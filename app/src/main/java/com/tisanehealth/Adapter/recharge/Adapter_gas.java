...
public class Adapter_gas extends RecyclerView.Adapter<Adapter_gas.MyViewHolder> {
    ...
    public Adapter_gas(Context mContext, List<RechargeListModel> electricitylist) {
