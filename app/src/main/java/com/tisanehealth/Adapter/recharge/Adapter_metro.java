...
public class Adapter_metro extends RecyclerView.Adapter<Adapter_metro.MyViewHolder> {
    ...
    public Adapter_metro(Context mContext, List<RechargeListModel> electricitylist) {
