...
public class Adapter_water extends RecyclerView.Adapter<Adapter_water.MyViewHolder> {
    ...
    public Adapter_water(Context mContext, List<RechargeListModel> electricitylist) {
