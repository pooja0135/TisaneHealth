...
public class SelfRepurchaseAdapter extends RecyclerView.Adapter<SelfRepurchaseAdapter.MyViewHolder> {

    private Context mContext;
    ArrayList<SelfRepurchaseModel>repurchaselist;
    int selectedPosition = -1;

    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView tvDate, tvInvoiceNumber,tvCenter,tvAmount,tvBusinessvalue,tvGrossAmount,tvSGStAmount,tvCGSTAmount,tvTotalAmount;
    ...
    public SelfRepurchaseAdapter(Context mContext,   ArrayList<SelfRepurchaseModel>repurchaselist) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.inflate_self_repurchase_list, parent, false);
