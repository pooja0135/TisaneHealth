...
public class RechargePostpaidActivity extends AppCompatActivity implements View.OnClickListener, PaymentResultWithDataListener {
    ...
    TextView tvContactName, tvContactNumber, tvAlphabet, tvChange;
    //RelativeLayout
    ...
    public void initialise() {
        ...
        operatorlist= Utils.GetRechargeValue("Mobile_Postpaid");
    ...
    public void showBottomSheetDialog() {
        ...
        final BottomSheetDialog dialog = new BottomSheetDialog(RechargePostpaidActivity.this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.rlCircleName:
                ...
                break;
            case R.id.tvChange:
                if (!hasPermissions(RechargePostpaidActivity.this, PERMISSIONS)) {
                    ActivityCompat.requestPermissions(RechargePostpaidActivity.this, PERMISSIONS, PERMISSION_REQUEST_CODE);
                } else {
                            ...
                            if (Status)
                            {
                                ...
                                try {
                                    if (Utils.isNetworkConnectedMainThred(RechargePostpaidActivity.this)) {
                                        ...
                                        loader.setCanceledOnTouchOutside(true);
                                        loader.setCancelable(false);
                                        RechargeOrderStatusApi("",OrderId,"Pending","Wallet","Wallet",TransactionId,"","","","","","Mobile_Postpaid");

                                    } else {
                                        EasyToast.error(RechargePostpaidActivity.this, "No Internet Connnection");
                                    }
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (Status)
                            {
                              /*  if (rech_status.equals("FAILED"))
                                {
                                    UpdateWalletApi(pref.get(AppSettings.UserId),etAmount.getText().toString(),"Failed");
                                }
                                else
                                {
                                    UpdateWalletApi(pref.get(AppSettings.UserId),etAmount.getText().toString(),"Success");
                                }
*/
                                EasyToast.error(RechargePostpaidActivity.this,"Recharge Successful.You will receive confirmation message in few minutes." );
                                startActivity(new Intent(RechargePostpaidActivity.this,DashBoardActivity.class));
                            }
                            else
                            {
                                EasyToast.error(RechargePostpaidActivity.this,response.getString("Msg") );
                        ...
                        try {
                            ...
                            if (resCode.equals("200")) {
                                if (Utils.isNetworkConnectedMainThred(RechargePostpaidActivity.this)) {
                                    ...
                                    loader.setCanceledOnTouchOutside(true);
                                    loader.setCancelable(false);
                                    RechargeOrderStatusUpdateApi("",OrderId,"Success","Wallet","Wallet",TransactionId,"","","","","","Mobile_Postpaid",   rech_mobile, rech_order_id, rech_status, rech_type);
                            ...
                            {
                                EasyToast.error(RechargePostpaidActivity.this, response.getString("resText"));
                                if (Utils.isNetworkConnectedMainThred(RechargePostpaidActivity.this)) {
                                    loader.show();
                                    loader.setCanceledOnTouchOutside(true);
                                    loader.setCancelable(false);
                            ...
                            {
                                Toast.makeText(RechargePostpaidActivity.this, response.getString("resText"), Toast.LENGTH_SHORT).show();
                                loader.cancel();
                            }
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject object) {
                        try {
                            ...
                            {
                                Toast.makeText(RechargePostpaidActivity.this, jsonObject.getString("resText"), Toast.LENGTH_SHORT).show();
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            {
                                EasyToast.error(RechargePostpaidActivity.this, "This UserId or Password is not valid.");
                                loader.dismiss();
                            }
